...
/*  Created On : 11-Nov-2017 11:01:05 p.m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	cnSimbolo varchar(15) NULL,
	cnDescripcion varchar(25) NULL
)
;
...
CREATE INDEX IXFK_cnPlanContable_cnMoneda ON cnPlanContable (fkMoneda ASC)
;
...
CREATE INDEX IXFK_cnProyecto_cnPlanContable ON cnProyecto (fkCtaCosto ASC)
;
...
ALTER TABLE cnPlanContable ADD CONSTRAINT FK_cnPlanContable_cnMoneda
